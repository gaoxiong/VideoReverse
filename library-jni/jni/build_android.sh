...
OS_ARCH=`basename $NDK/toolchains/arm-linux-androideabi-4.6/prebuilt/*`
function build_x264
{
...
ADDITIONAL_CONFIGURE_FLAG=
SONAME=libffmpeg.so
PREBUILT=$NDK/toolchains/arm-linux-androideabi-4.6/prebuilt/$OS_ARCH
...
SONAME=libffmpeg.so
PREBUILT=$NDK/toolchains/x86-4.6/prebuilt/$OS_ARCH
...
SONAME=libffmpeg.so
PREBUILT=$NDK/toolchains/mipsel-linux-android-4.6/prebuilt/$OS_ARCH
PLATFORM_VERSION=android-9
build_amr
build_aac
build_fribidi
